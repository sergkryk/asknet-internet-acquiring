...
function insertBankRequiredFields(
  request: BankRequestCandidate
): Omit<BankRequestCandidate, 'OperId'> & { TerminalKey: string; Password: string } {
...
): Omit<BankRequestCandidate, 'OperId'> & { Token: string } {
