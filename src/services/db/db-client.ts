...
class DatabaseClient {
    ...
    async insertPayment(data: PaymentData) {
        const query = `
            INSERT INTO payments (agrmid, success, error_code, terminal_key, status_id, payment_id, order_id, amount, payment_url)
    ...
    async updatePaymentStatus(paymentId: string, status: PaymentStatusIds) {
